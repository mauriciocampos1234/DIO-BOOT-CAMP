...
|--------|-----------|--------|
| Projeto | Criando um sistema de Gestão Escolar - ASPNET Core MVC, Lógica de Programação, POO C#, .NET Versão 8  | [`Ver Projeto`](https://github.com/mauriciocampos1234/sistema-gerenciamento-escola-completo) |
